...
setup(
    ...
    description='Flagger',
    install_requires=["numpy", "astropy", "matplotlib", "scipy>=0.15.1","julian","psutil","casatools","casatasks","casadata"]
    )
...
if os.path.isdir('calibrate_tools')==False:
	...
	os.system('rm -rf calibrate_tools/*')
os.chdir('calibrate_tools')
os.system('make clean')
os.system('cmake ../ -DPORTABEL=True -DCMAKE_PREFIX_PATH='+install_dir)
os.system('make')
os.chdir(cwd)
setup(
    name='CALIBRATE',
