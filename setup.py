...
setup(
    ...
    install_requires=["extension-helpers","certifi>=2020.06.20","pillow==8.2.0","ephem","bokeh==2.4.0","pyparsing==2.4.7","numpy==1.19.0", "scipy==1.6.2",\
	...
	'colorama',"dask-ms[xarray]","dask[complete]","datashader==0.12.0", "holoviews",'websockets==9.1','aiohttp==3.7.4','bson~=0.5.10','click==8.0.3',\
	"matplotlib","cmasher","future-fstrings","MSUtils",'shadems','Flask'],
