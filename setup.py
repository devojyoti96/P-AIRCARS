...
setup(
    ...
    install_requires=["optparse","extension-helpers","numpy>=1.19.0", "scipy>=0.15.1", "astropy==4.3", "skyfield", "matplotlib", "h5py","julian","psutil","casatools","casatasks","casadata","cmake"],
