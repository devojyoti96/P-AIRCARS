...
class Beam(object):
    ...
    def calc_beam_modes(self):
        ...
        for pol in [0, 1]:
            ...
            try:
                ...
                Q_modes_all = self.AA.h5f['modes'][()].T
            Nmax = 0
            M_accum = None
            N_accum = None
            for ant_i in range(n_ant):
    ...
    def get_FF(self, phi_arr, theta_arr, grid):
        ...
        for pol in [0, 1]:
            ...
            Jones[pol, 0] = Sigma_T
            Jones[pol, 1] = -Sigma_P#-Sigma_P  # 2017-05-30 : sign fixed by MS to reflect the fact that phi=90-az (it is not just change of values but orientation of base vector changes,
