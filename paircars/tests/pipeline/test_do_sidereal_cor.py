...
from paircars.pipeline.do_sidereal_cor import *
...
@patch("paircars.pipeline.do_sidereal_cor.drop_cache")
@patch("paircars.pipeline.do_sidereal_cor.time.sleep", return_value=None)
@patch("paircars.pipeline.do_sidereal_cor.delayed")
@patch("paircars.pipeline.do_sidereal_cor.get_local_dask_cluster")
@patch(
    "paircars.pipeline.do_sidereal_cor.initialize_wsclean_container",
    return_value=None,
)
@patch("paircars.pipeline.do_sidereal_cor.check_udocker_container")
@patch("paircars.pipeline.do_sidereal_cor.os.path.exists")
...
def test_main_sidereal(
    ...
    from paircars.pipeline.do_sidereal_cor import main
...
def test_cli_sidereal(
    ...
    with patch("sys.argv", argv):
        from paircars.pipeline import do_sidereal_cor
