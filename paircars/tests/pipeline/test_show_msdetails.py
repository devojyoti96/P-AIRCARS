...
from paircars.pipeline.show_msdetails import *
...
@patch("paircars.pipeline.show_msdetails.drop_cache")
@patch("paircars.pipeline.show_msdetails.print")
@patch("paircars.pipeline.show_msdetails.os.system")
@patch("paircars.pipeline.show_msdetails.open", new_callable=mock_open)
@patch("paircars.pipeline.show_msdetails.listobs")
@patch("paircars.pipeline.show_msdetails.os.path.exists")
...
@patch("paircars.pipeline.show_msdetails.show_listobs")
@patch("paircars.pipeline.show_msdetails.argparse.ArgumentParser.print_help")
@patch("paircars.pipeline.show_msdetails.sys.exit")
def test_cli(
    mock_exit,
    mock_print_help,
    mock_show_listobs,
