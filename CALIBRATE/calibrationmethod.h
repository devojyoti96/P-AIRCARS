...
class CalibrationMethod
{
	...
	public:
		...
		{
				//val = _jonesSolutions[antenna* 4 + polarization];
				//printf("%d, %d  : %lf , %lf \n",antenna,polarization,real(_jonesSolutions[antenna* 4 + polarization]),imag(_jonesSolutions[antenna* 4 + polarization]));
	...
	private:
		...
		double calculateChisq(std::complex<double> *nextJones);
